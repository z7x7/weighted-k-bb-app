...
st.title("Strikeout Prop Diagnostic (17-Trifecta + K Line Comparison)")
...
projected_ip = st.number_input("Projected Innings Pitched", value=6.0)
...
if st.button("Analyze"):
    ...
    st.write(f"🎯 Sportsbook K Line: {k_line}")
    ...
    if expected_ks > k_line:
        ...
        st.write("➖ Model is right on the line — no clear value")
