...
if st.button("Analyze"):
    ...
    results = {
        ...
        "xFIP - FIP vs RHB": evaluate_metric(xfip_fip_rhb_diff, {"over": 0.0, "neutral_low": -0.3, "neutral_high": 0.3}) if xfip_fip_rhb_diff <= 1.0 else "Under",
        "xFIP - FIP vs LHB": evaluate_metric(xfip_fip_lhb_diff, {"over": 0.0, "neutral_low": -0.3, "neutral_high": 0.3}) if xfip_fip_lhb_diff <= 1.0 else "Under"
    }
