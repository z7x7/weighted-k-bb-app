...
st.title("Weighted K% and BB% Calculator (Simplified)")

st.markdown("""
Enter pitcher stats by handedness and the opponent's lineup breakdown:
""")
...
if st.button("Calculate"):
    ...
    st.write(f"Effective % RHB: {percent_rhb * 100:.1f}%")
    st.write(f"Effective % LHB: {percent_lhb * 100:.1f}%")
